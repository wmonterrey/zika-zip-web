...
public class Zp05UltrasoundExam extends BaseMetaData implements Auditable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Zp05UltrasoundExam)) return false;

        Zp05UltrasoundExam that = (Zp05UltrasoundExam) o;
