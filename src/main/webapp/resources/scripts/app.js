...
var App = function () {
    ...
    var handleTheme = function () {
        ...
        "boxed"==localStorage.getItem("samp-layout")?(
        ...
        "fixed"==localStorage.getItem("samp-sidebar")?(
        		$("body").addClass("page-sidebar-fixed"),
        		$('.sidebar-option', panel).val("fixed")):(
        				$("body").removeClass("page-sidebar-fixed"),
        				$('.sidebar-option', panel).val("default"));
        
		"fixed"==localStorage.getItem("samp-header")?(
		...
		"fixed"==localStorage.getItem("samp-footer")?(
		...
		//sidebar position
        if (App.isRTL()) {
            if (localStorage.getItem("samp-sbpos") === 'left') {
            ...
            if (localStorage.getItem("samp-sbpos") === 'right') {
                $("body").addClass("page-sidebar-reversed");
                $('.sidebar-pos-option', panel).val("right");
            } else {
                $("body").removeClass("page-sidebar-reversed");
        ...
        var setLayout = function () {
            ...
            localStorage.setItem("samp-layout",layoutOption);
            var sidebarOption = $('.sidebar-option', panel).val();
            localStorage.setItem("samp-sidebar",sidebarOption);
            var headerOption = $('.header-option', panel).val();
            localStorage.setItem("samp-header",headerOption);
            var footerOption = $('.footer-option', panel).val();
            localStorage.setItem("samp-footer",footerOption);
            var sidebarPosOption = $('.sidebar-pos-option', panel).val();
            localStorage.setItem("samp-sbpos",sidebarPosOption);


            if (sidebarOption == "fixed" && headerOption == "default") {
                alert('Esta opcion no est� soportada. Para dejar fijo el menu tiene que dejar fijo el encabezado.');
                $('.header-option', panel).val("fixed");
                $('.sidebar-option', panel).val("fixed");
                sidebarOption = 'fixed';
                headerOption = 'fixed';
