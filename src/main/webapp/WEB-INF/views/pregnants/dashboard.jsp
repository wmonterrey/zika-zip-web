...
<body class="page-header-fixed page-sidebar-fixed page-footer-fixed">
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h3 class="page-title">
								...
								<small><spring:message code="pregnants" /> - <spring:message
										code="pregnantsdash" /></small>
							</h3>
							<ul class="page-breadcrumb breadcrumb">
								<li><i class="fa fa-home"></i> <a
									...
									href="<spring:url value="/pregnants/dashboard" htmlEscape="true "/>"><spring:message
											code="pregnantsdash" /></a></li>
							</ul>
												...
												<c:forEach items="${registros}" var="registro">
													<tr>
														...
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																<spring:param name="imagen" value="${registro.ingreso}" />
															</spring:url> <spring:url value="/pregnants/dashboard/{code}/{event}"
																htmlEscape="true" var="detalle">
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event" value="entry_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.ingreso}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																htmlEscape="true" var="detalle">
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event"
																	value="2_week_post_entry_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.semana2}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event"
																	value="4_week_post_entry_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.semana4}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event"
																	value="6_week_post_entry_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.semana6}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event"
																	value="8_week_post_entry_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.semana8}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event"
																	value="10_week_post_entry_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.semana10}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event"
																	value="12_week_post_entry_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.semana12}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event"
																	value="14_week_post_entry_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.semana14}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event"
																	value="16_week_post_entry_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.semana16}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event"
																	value="18_week_post_entry_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.semana18}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event"
																	value="20_week_post_entry_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.semana20}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event"
																	value="22_week_post_entry_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.semana22}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event"
																	value="24_week_post_entry_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.semana24}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event"
																	value="26_week_post_entry_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.semana26}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event"
																	value="28_week_post_entry_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.semana28}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event"
																	value="30_week_post_entry_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.semana30}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event"
																	value="32_week_post_entry_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.semana32}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event"
																	value="34_week_post_entry_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.semana34}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event"
																	value="36_week_post_entry_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.semana36}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event"
																	value="38_week_post_entry_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.semana38}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event"
																	value="40_week_post_entry_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.semana40}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event"
																	value="42_week_post_entry_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.semana42}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event"
																	value="44_week_post_entry_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.semana44}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																width="16px" height="16px" alt="${registro.parto}" />
														</a></td>
														<td align="center"><spring:url
																value="/resources/img/{imagen}.png" var="imgestado">
																...
																<spring:param name="code" value="${registro.codigo}" />
																<spring:param name="event"
																	value="6_week_post_partum_arm_1" />
															</spring:url> <a href="${detalle}"> <img src="${imgestado}"
																width="16px" height="16px" alt="${registro.posparto}" />
														</a></td>
													</tr>
												</c:forEach>
											</tbody>
	...
	<spring:url
		value="/resources/plugins/jquery.pwstrength.bootstrap/src/pwstrength.js"
		var="pwStrength" />
