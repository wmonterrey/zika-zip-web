						...
						<div class="col-md-12">
							...
							<h3 class="page-title">
								...
								<small><spring:message code="pregnants" /> - <spring:message
										code="pregnantsdash" /> - <spring:message code="detail" /></small>
							</h3>
							<ul class="page-breadcrumb breadcrumb">
								<li><i class="fa fa-home"></i> <a
									...
									href="<spring:url value="/pregnants/dashboard" htmlEscape="true "/>"><spring:message
											code="pregnantsdash" /></a> <i class="fa fa-angle-right"></i> <spring:message
										code="detail" /></li>
							</ul>
								...
								<div class="portlet-body">
									<div class="table-toolbar">
										<div class="btn-group">
											...
											<button id="lista_pregnantsdash"
												onclick="location.href='${fn:escapeXml(pregnantsdash)}'"
												class="btn btn-info">
												<spring:message code="pregnantsdash" />
									...
									<form class="form-horizontal">
										<div class="form-body">
											<h3 class="form-section">
												<c:out value="${detalle.codigo}" />
											</h3>
											<div class="row">
												<div class="col-md-6">
													<div class="form-group">
														<label class="control-label col-md-3"><spring:message
																code="diary.registerdate" />:</label>
														<div class="col-md-9">
