...
<body>
	...
	<c:set var="passUpdated">
		<spring:message code="pass.updated" />
	</c:set>
	...
	<c:set var="notif">
		<spring:message code="not" />
	</c:set>
	<c:set var="sessionExpiring">
		<spring:message code="session.expiring" />
	</c:set>
	<c:set var="sessionExpiringTime">
		<spring:message code="session.expiring.time" />
	</c:set>
	<c:set var="sessionExpiringConfirm">
		<spring:message code="session.expiring.confirm" />
	</c:set>
	<c:set var="seconds">
		<spring:message code="seconds" />
	</c:set>
	<c:set var="keepSession">
		<spring:message code="session.keep" />
	</c:set>
	<c:set var="logoutSession">
			...
			<div class="portlet">
				<div class="portlet-title">
					<div class="caption">
						...
						<spring:message code="changepass" />
					</div>
				</div>
				<div class="portlet-body form">
					<form action="#" autocomplete="off" id="chg-pass-form"
						...
						<div class="form-body">
							...
							<div class="form-group">
								<label class="control-label col-md-3"><spring:message
										code="login.username" /> <span class="required"> * </span> </label>
								<div class="col-md-5">
							...
							<div class="form-group password-strength">
								<label class="control-label col-md-3"><spring:message
										code="login.password" /> <span class="required"> * </span> </label>
								<div class="col-md-5">
							...
							<div class="form-group">
								<label class="control-label col-md-3"><spring:message
										code="password.repeat" /> <span class="required"> * </span> </label>
								<div class="col-md-5">
						...
						<div class="form-actions fluid">
							<div class="col-md-offset-6 col-md-6">
								...
								<a href="${fn:escapeXml(logoutUrl)}" class="btn btn-danger"><spring:message
										code="cancel" /></a>
							</div>
						</div>
					</form>
	...
	<spring:url value="/resources/scripts/idle-timeout.js"
		var="idleTimeOutJs" />
	...
	<spring:url value="/resources/scripts/users/chgpass-user.js"
		var="chgPassScript" />
