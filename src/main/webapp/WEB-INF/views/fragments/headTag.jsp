...
-->
<meta charset="utf-8" />
<title><spring:message code="title" /> | <spring:message
		code="heading" /></title>
...
<spring:url
	value="/resources/plugins/font-awesome/css/font-awesome.min.css"
	var="fontawesome" />
<link href="${fontawesome}" rel="stylesheet" type="text/css" />
<spring:url value="/resources/plugins/bootstrap/css/bootstrap.min.css"
	var="bootstrap" />
<link href="${bootstrap}" rel="stylesheet" type="text/css" />
<spring:url value="/resources/plugins/uniform/css/uniform.default.css"
	var="uniform" />
<link href="${uniform}" rel="stylesheet" type="text/css" />
<spring:url value="/resources/plugins/bootstrap-toastr/toastr.min.css"
	var="toastcss" />
...
<spring:url value="/resources/css/style-responsive.css"
	var="sresponsive" />
...
<link href="${defaults}" rel="stylesheet" type="text/css"
	id="style_color" />
