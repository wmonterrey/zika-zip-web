...
<body class="page-header-fixed page-sidebar-fixed page-footer-fixed">
										...
										<div class="form-body">
											...
											<div class="row">
												<div class="col col-sm-12 col-md-6 col-lg-6">
													<div class="form-group">
														<label class="control-label col-md-4"><spring:message
																code="subjectId.start" /> </label>
														<div class="col-md-6">
															<div class="input-group">
																<input id="codigoInicio" name="codigoInicio" type="text"
												...
												<div class="col col-sm-12 col-md-6 col-lg-6">
													<div class="form-group">
														<label class="control-label col-md-4"><spring:message
																code="subjectId.end" /> </label>
														<div class="col-md-6">
															<div class="input-group">
																<input id="codigoFin" name="codigoFin" type="text"
																	value="" class="form-control" /> <span
																	class="input-group-addon"> <i
																	class="fa fa-sort-alpha-asc"></i>
																</span>
	...
	<spring:url value="/resources/scripts/export/process-export.js"
		var="procExportScript" />
