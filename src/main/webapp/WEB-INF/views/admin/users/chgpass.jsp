						...
						<div class="col-md-12">
							...
							<ul class="page-breadcrumb breadcrumb">
								<li><i class="fa fa-home"></i> <a
									...
									href="<spring:url value="/admin/users/chgpass/${user.username}" htmlEscape="true "/>"><spring:message
											code="changepass" /></a></li>
							</ul>
												...
												<div class="col-md-5">
													<div class="input-group">
														<input id="confirm_password" name="confirm_password"
															...
															class="input-group-addon"> <i class="fa fa-lock"></i>
														</span>
													</div>
												</div>
											</div>
