					...
					<div class="row">
						<div class="col-md-12">
									...
									<div class="table-toolbar">
										<div class="btn-group">
											...
											<button id="lista_usuarios_new"
												onclick="location.href='${fn:escapeXml(newUser)}'"
										...
										<table class="table table-striped table-hover table-bordered"
											...
											<c:forEach items="${usuarios}" var="usuario">
												<tr>
													...
													<td><a href="${fn:escapeXml(usuarioUrl)}"
														...
														<a href="${fn:escapeXml(chgpassUrl)}"
														class="btn btn-default btn-xs"><i class="fa fa-key"></i></a>
														<c:choose>
															<c:when test="${usuario.enabled}">
																<a data-toggle="modal"
																	data-id="${fn:escapeXml(disableUrl)}"
																	class="btn btn-default btn-xs desact"><i
																	class="fa fa-trash-o"></i></a>
															</c:when>
															<c:otherwise>
																<a data-toggle="modal"
																	data-id="${fn:escapeXml(enableUrl)}"
																	class="btn btn-default btn-xs act"><i
																	class="fa fa-check"></i></a>
															</c:otherwise>
														</c:choose> <c:choose>
															<c:when test="${usuario.accountNonLocked}">
																<a data-toggle="modal"
																	data-id="${fn:escapeXml(lockUrl)}"
																	class="btn btn-default btn-xs lock"><i
																	class="fa fa-lock"></i></a>
															</c:when>
															<c:otherwise>
																<a data-toggle="modal"
																	data-id="${fn:escapeXml(unlockUrl)}"
																	class="btn btn-default btn-xs unlock"><i
							...
							<div class="modal fade" id="basic" tabindex="-1"
								data-role="basic" data-backdrop="static" data-aria-hidden="true">
