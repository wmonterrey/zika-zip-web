...
<body class="page-header-fixed page-sidebar-fixed page-footer-fixed">
		...
		<div class="page-content-wrapper">
			<div class="page-content-wrapper">
				<div class="page-content">
						...
						<div class="col-md-12">
							...
							<ul class="page-breadcrumb breadcrumb">
								<li><i class="fa fa-home"></i> <a
									...
									href="<spring:url value="/admin/users/editUser/${user.username}" htmlEscape="true "/>">${user.username}</a>
								</li>
							</ul>
					...
					<c:set var="userUpdated">
						<spring:message code="user.updated" />
					</c:set>
					<c:set var="errorProcess">
						<spring:message code="process.error" />
					</c:set>
						...
						<div class="col-md-12">
							<div class="portlet">
								...
								<div class="portlet-body form">
									<form action="#" autocomplete="off" id="edit-user-form"
										...
										<div class="form-body">
											...
											<div class="form-group">
												<label class="control-label col-md-3"><spring:message
														code="username" /> <span class="required"> * </span> </label>
												<div class="col-md-5">
													<div class="input-group">
														<input id="username" name="username" type="text" readonly
															value="${user.username}" class="form-control" /> <span
											...
											<div class="form-group">
												<label class="control-label col-md-3"><spring:message
														code="userdesc" /> <span class="required"> * </span> </label>
												<div class="col-md-5">
													<div class="input-group">
														<input id="completeName" name="completeName" type="text"
															value="${user.completeName}" class="form-control" /> <span
															class="input-group-addon"> <i class="fa fa-user"></i>
														</span>
													</div>
												</div>
											...
											<div class="form-group">
												<label class="control-label col-md-3"><spring:message
														code="useremail" /> <span class="required"> * </span> </label>
												<div class="col-md-5">
													<div class="input-group">
														<input id="email" name="email" type="text"
															value="${user.email}" class="form-control" /> <span
											...
											<div id="divPass" class="form-group password-strength">
												<label class="control-label col-md-3"><spring:message
														code="login.password" /> <span class="required"> *
												</span> </label>
												<div class="col-md-5">
													<input id="password" name="password" type="password"
														class="form-control" /> <span class="help-block"> <spring:message
															code="Pattern.password.format" />
													</span>
												</div>
											</div>
											<div id="divPassRepeat" class="form-group">
												<label class="control-label col-md-3"><spring:message
														code="password.repeat" /> <span class="required">
														* </span> </label>
												<div class="col-md-5">
											...
											<div class="form-group">
												<label class="control-label col-md-3"><spring:message
														code="userroles" /> <span class="required"> * </span> </label>
												<div class="col-md-5">
													<select multiple="multiple" class="multi-select"
														id="authorities" name="authorities">
														<c:forEach items="${rolesusuario}" var="auth"
															varStatus="stat">
															<c:set var="rolesUsuario"
																value="${stat.first ? '' : rolesUsuario} ${auth.authId.authority}" />
														</c:forEach>
														<c:forEach items="${roles}" var="rol">
															<c:choose>
																<c:when
																	test="${fn:contains(rolesUsuario, rol.authority)}">
											...
											<div class="form-group">
												<label class="control-label col-md-3"><spring:message
														code="usercenters" /> <span class="required"> * </span> </label>
												<div class="col-md-5">
													<select multiple="multiple" class="multi-select"
														id="centers" name="centers">
														<c:forEach items="${centrosusuario}" var="center"
															varStatus="stat">
															<c:set var="centrosUsuario"
																value="${stat.first ? '' : centrosUsuario} ${center.userCenterId.center}" />
														</c:forEach>
										...
										<div class="form-actions fluid">
											<div class="col-md-offset-6 col-md-6">
												...
												<a href="${fn:escapeXml(usuarioUrl)}" class="btn btn-danger"><spring:message
														code="end" /></a>
											</div>
										</div>
									</form>
	...
	<spring:url value="/resources/scripts/users/process-user.js"
		var="editUserScript" />
