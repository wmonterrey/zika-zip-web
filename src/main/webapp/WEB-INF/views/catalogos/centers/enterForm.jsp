							...
							<ul class="page-breadcrumb breadcrumb">
								<li><i class="fa fa-home"></i> <a
									...
									href="<spring:url value="/catalog/centers/" htmlEscape="true "/>"><spring:message
											...
											<a
									href="<spring:url value="#" htmlEscape="true "/>">${unidad.cs}
									</a>
									...
									<form action="#" autocomplete="off" id="add-center-form"
										...
										<div class="form-body">
											...
											<div class="form-group">
												<label class="control-label col-md-3"><spring:message
														code="centerName" /> <span class="required"> * </span> </label>
												<div class="col-md-5">
													<div class="input-group">
														<input id="centerName" name="centerName" type="text"													
															placeholder="<spring:message code="please.enter" /> 
															<spring:message code="centerName" />"
															value="${unidad.cs}" class="form-control" /> 
										...
										<div class="form-actions fluid">
											<div class="col-md-offset-6 col-md-6">
												...
												<a href="${fn:escapeXml(centerUrl)}" class="btn btn-danger"><spring:message
														code="cancel" /></a>
											</div>
										</div>
									</form>
