...
<body class="page-header-fixed page-sidebar-fixed page-footer-fixed">
						...
						<div class="col-md-12">
							...
							<ul class="page-breadcrumb breadcrumb">
								<li><i class="fa fa-home"></i> <a
									...
									href="<spring:url value="/catalog/subjectTypes/" htmlEscape="true "/>"><spring:message
											code="subjtypes" /></a></li>
							</ul>
						...
						<div class="col-md-12">
							<div class="portlet">
								...
								<div class="portlet-body form">
									<form action="#" autocomplete="off" id="add-subject-form"
										...
										<div class="form-body">
											...
											<div class="form-group">
												<label class="control-label col-md-3"><spring:message
														code="subjtypeName" /> <span class="required"> * </span>
												</label>
												<div class="col-md-5">
													<div class="input-group">
														<input id="subjectType" name="subjectType" type="text"
															placeholder="<spring:message code="please.enter" /> <spring:message code="subjtypeName" />"
										...
										<div class="form-actions fluid">
											<div class="col-md-offset-6 col-md-6">
												...
												<a href="${fn:escapeXml(subjectUrl)}" class="btn btn-danger"><spring:message
														code="cancel" /></a>
											</div>
										</div>
									</form>
	...
	<spring:url value="/resources/scripts/catalog/process-subject.js"
		var="subjectScript" />
