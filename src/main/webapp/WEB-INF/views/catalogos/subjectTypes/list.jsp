					...
					<div class="row">
						<div class="col-md-12">
							...
							<h3 class="page-title">
								...
								<small><spring:message code="subjtypes" /></small>
							</h3>
							<ul class="page-breadcrumb breadcrumb">
								<li><i class="fa fa-home"></i> <a
									href="<spring:url value="/" htmlEscape="true "/>"><spring:message
											code="home" /></a> <i class="fa fa-angle-right"></i> <a
									href="<spring:url value="/catalog/subjTypes/" htmlEscape="true "/>"><spring:message
											code="subjtypes" /></a></li>
							</ul>
							...
							<div class="portlet">
								...
								<div class="portlet-body">
									<div class="table-toolbar">
										<div class="btn-group">
											<spring:url value="/catalog/newSubjectType"
												var="newSubjectType" />
											<button id="lista_sujetos_new"
												onclick="location.href='${fn:escapeXml(newSubjectType)}'"
