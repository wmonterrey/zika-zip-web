...
<body class="page-header-fixed page-sidebar-fixed page-footer-fixed">
						...
						<div class="col-md-12">
							...
							<ul class="page-breadcrumb breadcrumb">
								<li><i class="fa fa-home"></i> <a
									...
									href="<spring:url value="/catalog/editProvider/${provider.id}/" htmlEscape="true "/>">${provider.id}</a>
								</li>
							</ul>
						...
						<div class="col-md-12">
							<div class="portlet">
								...
								<div class="portlet-body form">
									<form action="#" autocomplete="off" id="add-provider-form"
										...
										<div class="form-body">
											...
											<div class="form-group">
												<label class="control-label col-md-3"><spring:message
														code="providername" /> <span class="required"> * </span>
												</label>
												<div class="col-md-5">
													<div class="input-group">
														<input value="${provider.name}" id="providerName"
															name="providerName" type="text"
															placeholder="<spring:message code="please.enter" /> <spring:message code="providername" />"
															class="form-control" /> <span class="input-group-addon">
															<i class="fa fa-keyboard-o"></i>
														</span>
													</div>
											...
											<div class="form-group">
												<label class="control-label col-md-3"><spring:message
														code="superstudies" /> </label>
												<div class="col-md-5">
													<select
														data-placeholder="<spring:message code="select" /> <spring:message code="superstudies" />"
														name="especialidadProveedor" id="especialidadProveedor" class="form-control">
														<option value=""></option>
										...
										<div class="form-actions fluid">
											<div class="col-md-offset-6 col-md-6">
												...
												<a href="${fn:escapeXml(providerUrl)}" class="btn btn-danger"><spring:message
														code="end" /></a>
											</div>
										</div>
									</form>
	...
	<spring:url value="/resources/scripts/catalog/process-provider.js"
		var="providerScript" />
	<script src="${providerScript}" type="text/javascript"></script>
	<spring:url
	...
	<spring:url value="/catalog/saveProvider" var="saveProviderUrl" />
	...
	jQuery(document).ready(function() {
		App.init();
		var parametros = {saveProviderUrl: "${saveProviderUrl}",
				providerUrl: "${providerUrl}",
				successmessage: "${successmessage}",
				errormessage: "${errormessage}"};
		EditProvider.init(parametros);
		$('#providername').focus();
	});	
</script>
	<!-- END JAVASCRIPTS -->
