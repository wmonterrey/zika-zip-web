...
<body class="page-header-fixed page-sidebar-fixed page-footer-fixed">
	...
	<div class="page-container">
		...
		<!-- BEGIN CONTENT -->
		<c:set var="providerEnabledLabel">
			<spring:message code="provider.enabled" />
		</c:set>
		<c:set var="providerDisabledLabel">
			<spring:message code="provider.disabled" />
		</c:set>
		<c:set var="habilitar">
		...
		<spring:url value="/catalog/providers/act/disable2/{provider}/"
			var="disableUrl">
			<spring:param name="provider" value="${provider.id}" />
		</spring:url>
		<spring:url value="/catalog/providers/act/enable2/{provider}/"
			var="enableUrl">
			<spring:param name="provider" value="${provider.id}" />
		</spring:url>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<h3 class="page-title">
								...
								<small><spring:message code="providers" /></small>
							</h3>
							<ul class="page-breadcrumb breadcrumb">
								<li><i class="fa fa-home"></i> <a
									href="<spring:url value="/" htmlEscape="true "/>"><spring:message
											code="home" /></a> <i class="fa fa-angle-right"></i> <a
									href="<spring:url value="/catalog/providers/" htmlEscape="true "/>"><spring:message
											code="providers" /></a> <i class="fa fa-angle-right"></i> <a
									href="<spring:url value="/catalog/viewProvider/${provider.id}/" htmlEscape="true "/>">${provider.id}</a>
								</li>
							</ul>
								...
								<div class="portlet-body">
									<div class="table-toolbar">
										<div class="btn-group">
											...
											<button id="lista_proveedores"
												onclick="location.href='${fn:escapeXml(listProvider)}'"
												class="btn btn-info">
									...
									<form class="form-horizontal">
										<div class="form-body">
											<h3 class="form-section">
												<spring:message code="providerid" />
												:
