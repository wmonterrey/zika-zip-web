		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					<spring:message code="title" /> <small><spring:message code="specialities" /></small>
					</h3>
					...
					<div class="portlet">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="btn-group">
									<spring:url value="/catalog/newSpeciality"	var="newSpeciality"/>
									<button id="lista_especialidades_new" onclick="location.href='${fn:escapeXml(newSpeciality)}'" class="btn btn-success">
									<spring:message code="add" /> <i class="fa fa-plus"></i>
									</button>
								</div>
							</div>
							<div class="table-responsive">
							<table class="table table-striped table-hover table-bordered" id="lista_especialidades">
							<thead>
								<tr>
							...
							<c:forEach items="${especialidades}" var="especialidad">
								<tr>
									<td><c:out value="${especialidad.speciality}" /></td>
								</tr>
							</c:forEach>
							</table>
							</div>
...
<script>
	jQuery(document).ready(function() {
		App.init();
		var table  = $('#lista_especialidades').DataTable({
