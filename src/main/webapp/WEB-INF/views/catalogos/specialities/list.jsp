					...
					<div class="row">
						<div class="col-md-12">
							...
							<h3 class="page-title">
								...
								<small><spring:message code="specialities" /></small>
							</h3>
							...
							<div class="portlet">
								...
								<div class="portlet-body">
									<div class="table-toolbar">
										<div class="btn-group">
											<spring:url value="/catalog/newSpeciality"
												var="newSpeciality" />
											<button id="lista_especialidades_new"
												onclick="location.href='${fn:escapeXml(newSpeciality)}'"
