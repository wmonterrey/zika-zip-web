					...
					<div class="row">
						<div class="col-md-12">
							...
							<h3 class="page-title">
								...
								<small><spring:message code="appointmentTypes" /></small>
							</h3>
							<ul class="page-breadcrumb breadcrumb">
								<li><i class="fa fa-home"></i> <a
									href="<spring:url value="/" htmlEscape="true "/>"><spring:message
											code="home" /></a> <i class="fa fa-angle-right"></i> <a
									href="<spring:url value="/catalog/appointmenttypes/" htmlEscape="true "/>"><spring:message
								...
								<div class="portlet-body">
									<div class="table-toolbar">
										<div class="btn-group">
											...
											<button id="lista_tipos_new"
												onclick="location.href='${fn:escapeXml(newAppType)}'"
