		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					<spring:message code="title" /> <small><spring:message code="appointmentTypes" /></small>
					</h3>
					<ul class="page-breadcrumb breadcrumb">
						<li>
							<i class="fa fa-home"></i>
							<a href="<spring:url value="/" htmlEscape="true "/>"><spring:message code="home" /></a>
							<i class="fa fa-angle-right"></i> <a href="<spring:url value="/catalog/appointmenttypes/" htmlEscape="true "/>"><spring:message code="appointmentTypes" /></a>
						</li>
					</ul>
					...
					<div class="portlet">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="btn-group">
									<spring:url value="/catalog/newAppType"	var="newAppType"/>
									<button id="lista_tipos_new" onclick="location.href='${fn:escapeXml(newAppType)}'" class="btn btn-success">
									<spring:message code="add" /> <i class="fa fa-plus"></i>
									</button>
								</div>
							</div>
							<div class="table-responsive">
							<table class="table table-striped table-hover table-bordered" id="lista_tipos">
							<thead>
								<tr>
									<th><spring:message code="appointmentType" /></th>
								</tr>
							</thead>
							<c:forEach items="${tipos}" var="tipo">
								<tr>
									<td><c:out value="${tipo.appointmentType}" /></td>
								</tr>
							</c:forEach>
							</table>
							</div>
...
<script>
	jQuery(document).ready(function() {
		App.init();
		var table  = $('#lista_tipos').DataTable({
