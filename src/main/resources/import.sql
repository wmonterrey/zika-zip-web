...
INSERT INTO `zika_zip`.`messages` (`messageKey`, `catPasive`, `es`) VALUES ('exam_1_arm_2', '0', 'Examen 1');
INSERT INTO `zika_zip`.`messages` (`messageKey`, `catPasive`, `es`) VALUES ('exam_2_arm_2', '0', 'Examen 2');
INSERT INTO `zika_zip`.`messages` (`messageKey`, `catPasive`, `es`) VALUES ('exam_3_arm_2', '0', 'Examen 3');
INSERT INTO `zika_zip`.`messages` (`messageKey`, `catPasive`, `es`) VALUES ('exam_4_arm_2', '0', 'Examen 4');
INSERT INTO `zika_zip`.`messages` (`messageKey`, `catPasive`, `es`) VALUES ('exam_5_arm_2', '0', 'Examen 5');
INSERT INTO `zika_zip`.`messages` (`messageKey`, `catPasive`, `es`) VALUES ('exam_6_arm_2', '0', 'Examen 6');
...
INSERT INTO `zika_zip`.`messages` (`messageKey`, `catPasive`, `es`) VALUES ('zp07a', '0', 'Formulario Zp07a Resultados Oftalmol�gicos de Infante');
INSERT INTO `zika_zip`.`messages` (`messageKey`, `catPasive`, `es`) VALUES ('zp07b', '0', 'Formulario Zp07b Resultados de Ex�menes Audiol�gicos de Infante');
INSERT INTO `zika_zip`.`messages` (`messageKey`, `catPasive`, `es`) VALUES ('zp07c', '0', 'Formulario Zp07c Estudios de Im�genes de Infante');
...
INSERT INTO `zika_zip`.`messages` (`messageKey`, `catPasive`, `es`) VALUES ('zp07oae', '0', 'Formulario Zp07 Emisiones Otoacústicas');
...
INSERT INTO `zika_zip`.`messages` (`messageKey`, `catPasive`, `es`) VALUES ('catalog', '0', 'Cat�logos');
...
INSERT INTO `zika_zip`.`Messages` (`messageKey`, `catPasive`,`es`) VALUES ('phone_number', '0', 'N�mero Tel�fono');
INSERT INTO `zika_zip`.`Messages` (`messageKey`, `catPasive`,`es`) VALUES ('sms_number', '0', 'N�mero Mensaje');
...
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'consent', '¿Se obtuvo consentimiento para enrolar al infante?','0');
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'numBirth', 'Número de infantes nacidos','0');
