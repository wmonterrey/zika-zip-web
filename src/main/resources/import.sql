...
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'admin', 'Administraci�n','0');
...
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'changepass', 'Cambiar contrase�a..','0');
...
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'not', 'Notificaci�n','0');
...
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'session.expiring', 'Su sesi�n est� a punto de expirar!','0');
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'session.expiring.confirm', 'Quiere continuar con su sesi�n?','0');
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'session.expiring.time', 'Su sesi�n se cerrar� en','0');
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'session.keep', 'Mantener sesi�n','0');
/*Metadata*/
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'createdBy', 'Creado por','0');
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'dateCreated', 'Fecha creaci�n','0');
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'modifiedBy', 'Modificado por','0');
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'dateModified', 'Fecha de modificaci�n','0');
...
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'login.accountLocked', 'Cuenta de usuario est� bloqueada!','0');
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'login.accountNotLocked', 'Cuenta de usuario est� desbloqueada!','0');
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'login.badCredentials', 'Nombre de usuario o contrase�a incorrectos!','0');
...
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'login.maxSessionsOut', 'Tiene una sesi�n activa! No puede crear otra!','0');
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'login.msg', 'Por favor ingresar su nombre de usuario y contrase�a','0');
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'login.page', 'P�gina de ingreso','0');
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'login.password', 'Contrase�a','0');
...
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'credentials.expired', 'Su contrase�a ha caducado','0');
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'pass.updated', 'Su contrase�a ha sido actualizada','0');
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'password.repeat', 'Repita la contrase�a','0');
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'Pattern.password.format', 'Al menos 8 caracteres combinando may�sculas, min�sculas, n�meros y caracteres especiales','0');
/*Plantilla*/
...
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'userdesc', 'Descripci�n','0');
...
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'usercred', 'Contrase�a vencida','0');
...
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'dateCredentials', 'Ultimo cambio de contrase�a','0');
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'session', 'Id de sesi�n','0');
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'ipaddress', 'Direcci�n IP','0');
...
/*Audit trail*/
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'audittrail', 'Bit�cora de cambios','0');
...
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'theme.layout', 'Dise�o','0');
...
INSERT INTO `messages` (`messageKey`, `es`, `catPasive`) VALUES ( 'theme.sbposition', 'Posici�n Barra lateral','0');
...
INSERT INTO `messages` (`messageKey`, `catPasive`, `es`) VALUES ('restitle', '0', 'T�tulo');
INSERT INTO `messages` (`messageKey`, `catPasive`, `es`) VALUES ('mxcode', '0', 'C�digo Muestra');
INSERT INTO `messages` (`messageKey`, `catPasive`, `es`, `en`) VALUES ('codenotfound', '0', 'C�digo de muestra no encontrado: ?', 'Sample code not found : ?');
...
INSERT INTO `messages` (`messageKey`, `catPasive`, `es`) VALUES ('zp01AD', '0', 'Formulario Zp01 Ingreso Sección A-D');
INSERT INTO `messages` (`messageKey`, `catPasive`, `es`) VALUES ('zp01E', '0', 'Formulario Zp01 Ingreso Sección E');
INSERT INTO `messages` (`messageKey`, `catPasive`, `es`) VALUES ('zp01FK', '0', 'Formulario Zp01 Ingreso Sección F-K');
INSERT INTO `messages` (`messageKey`, `catPasive`, `es`) VALUES ('zp02', '0', 'Formulario Zp02 Muestras Biológicas');
INSERT INTO `messages` (`messageKey`, `catPasive`, `es`) VALUES ('zp03', '0', 'Formulario Zp03 Visita Mensual');
INSERT INTO `messages` (`messageKey`, `catPasive`, `es`) VALUES ('zp04AD', '0', 'Formulario Zp04 Visita Trimestral Sección A-D');
INSERT INTO `messages` (`messageKey`, `catPasive`, `es`) VALUES ('zp04E', '0', 'Formulario Zp04 Visita Trimestral Sección E');
INSERT INTO `messages` (`messageKey`, `catPasive`, `es`) VALUES ('zp04FH', '0', 'Formulario Zp04 Visita Trimestral Sección F-H');
...
INSERT INTO `zika_zip`.`messages` (`messageKey`, `catPasive`, `es`) VALUES ('subjectId', '0', 'Código de participante');
